...
export default function Page() {
  return (
    ...
    <h1 className="text-4xl sm:text-5xl mb-4 text-center max-w-[400px] tracking-wide">Kara's Chicken Coop Registration</h1>
    <h2 className="text-2xl font-bold tracking-wide p-2 text-center uppercase"> Register </h2>
      ...
      <label className="input input-bordered max-w-[400px] flex items-center gap-2 bg-white text-floc-gray">
        ...
        <button className="mx-auto flex justify-center w-full px-4 py-2 bg-blue-200 hover:bg-blue-100" type="submit">
          Register
        </button>
      </form>
      </div>
