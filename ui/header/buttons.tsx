...
export function ShopButton({
  ...
  return <button className="hidden sm:block pr-5 pl-5 pt-3 pb-3 bg-floc-yellow uppercase" >Shop</button>;
}

export function JoinTheFlockButton({
}: Readonly<{
}>) {
  return <button className=" pr-5 pl-5 pt-3 pb-3 border-solid border-[.25em] border-floc-gray text-floc-gray uppercase">Join The Flock</button>;
}


export function HamburgerMenu({
}: Readonly<{
}>) { return <button data-collapse-toggle="navbar-cta" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-floc-gray rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="navbar-cta" aria-expanded="false">
...
export function HeroCTA({
  ...
  return <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-xl text-center text-floc-gray  bg-floc-yellow uppercase">
  Join The Flock
</a> ;
}
